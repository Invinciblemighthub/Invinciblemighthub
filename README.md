...
<!--
  ===== README_A · 赛博朋克 / 黑客终端风 =====
  [GitHub-safe] 已移除全部 <style> 块；动画采用纯 SVG <animate>/<animateTransform>
-->

<!-- ===== HERO：CRT 显示器 + 矩阵雨 + 扫描线（全部 SVG animate） ===== -->
<div style="position:relative;background:#000;border:3px solid #00FF41;border-radius:18px;padding:40px 20px 30px 20px;overflow:hidden;box-shadow:0 0 60px #00FF41 inset, 0 0 80px rgba(0,255,65,.3);">

  <!-- 扫描线：SVG animate Y -->
  <div style="position:absolute;inset:0;z-index:6;pointer-events:none;">
    <svg width="100%" height="100%" viewBox="0 0 800 400" preserveAspectRatio="none">
      <rect x="0" y="-10%" width="100%" height="8%" fill="#00FF41" opacity=".35">
        <animate attributeName="y" from="-10%" to="110%" dur="6s" repeatCount="indefinite"/>
      </rect>
    </svg>
  </div>

  <!-- CRT 横纹：SVG 条纹 -->
  <div style="position:absolute;inset:0;pointer-events:none;z-index:5;opacity:.35;">
    <svg width="100%" height="100%" viewBox="0 0 4 400" preserveAspectRatio="none">
      <rect width="4" height="2" fill="#00FF41"/>
      <rect y="2" width="4" height="2" fill="#00FF41" opacity=".0"/>
    </svg>
  </div>

  <!-- 矩阵雨：每个字符独立 SVG animate Y -->
  <div style="position:absolute;inset:0;opacity:.22;z-index:1;">
    <svg width="100%" height="100%" viewBox="0 0 600 400" preserveAspectRatio="none">
      <g fill="#00FF41" font-family="Courier New" font-size="16" font-weight="700">
        <text><animate attributeName="x" values="20;20" dur="4s"/><animate attributeName="y" values="-20;400" dur="4s" repeatCount="indefinite"/>01001010</text>
        <text><animate attributeName="x" values="60;60" dur="5.2s"/><animate attributeName="y" values="-20;400" dur="5.2s" repeatCount="indefinite"/>AI#NLP$</text>
        <text><animate attributeName="x" values="110;110" dur="3.6s"/><animate attributeName="y" values="-20;400" dur="3.6s" repeatCount="indefinite"/>JD%评论^</text>
        <text><animate attributeName="x" values="160;160" dur="6.1s"/><animate attributeName="y" values="-20;400" dur="6.1s" repeatCount="indefinite"/>1101001</text>
        <text><animate attributeName="x" values="210;210" dur="4.4s"/><animate attributeName="y" values="-20;400" dur="4.4s" repeatCount="indefinite"/>KMeans++</text>
        <text><animate attributeName="x" values="260;260" dur="5.8s"/><animate attributeName="y" values="-20;400" dur="5.8s" repeatCount="indefinite"/>爬虫ROOT</text>
        <text><animate attributeName="x" values="310;310" dur="3.9s"/><animate attributeName="y" values="-20;400" dur="3.9s" repeatCount="indefinite"/>0xDEAD</text>
        <text><animate attributeName="x" values="360;360" dur="5.5s"/><animate attributeName="y" values="-20;400" dur="5.5s" repeatCount="indefinite"/>TFIDF_V</text>
        <text><animate attributeName="x" values="410;410" dur="4.7s"/><animate attributeName="y" values="-20;400" dur="4.7s" repeatCount="indefinite"/>Modal_v3</text>
        <text><animate attributeName="x" values="460;460" dur="6.3s"/><animate attributeName="y" values="-20;400" dur="6.3s" repeatCount="indefinite"/>0xBABE</text>
        <text><animate attributeName="x" values="510;510" dur="4.1s"/><animate attributeName="y" values="-20;400" dur="4.1s" repeatCount="indefinite"/>SQLite3</text>
        <text><animate attributeName="x" values="560;560" dur="5.0s"/><animate attributeName="y" values="-20;400" dur="5.0s" repeatCount="indefinite"/>1010101</text>
      </g>
    </svg>
  </div>

  <!-- 主标题：SVG 内绘制 + opacity 闪烁 animate -->
  <div style="position:relative;z-index:2;">
    <svg width="100%" height="110" viewBox="0 0 800 110">
      <defs>
        <filter id="neonA" x="-20%" y="-20%" width="140%" height="140%">
          <feGaussianBlur stdDeviation="2.8" result="b"/>
          <feMerge><feMergeNode in="b"/><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge>
        </filter>
      </defs>
      <text x="400" y="55" text-anchor="middle" font-family="Courier New" font-weight="900" font-size="34" fill="#00FF41" filter="url(#neonA)" letter-spacing="3">
        [ AI · MARKET · DEMAND · v3.0 ]
        <animate attributeName="opacity" values="1;0.35;1;1;0.4;1;1" dur="3.2s" repeatCount="indefinite"/>
      </text>
      <text x="400" y="92" text-anchor="middle" font-family="Courier New" font-size="15" fill="#00FF41" opacity=".9" letter-spacing="1">
        ▸ 京东差评采集 // 痛点聚类分析 // Selenium Matrix Pipeline
        <animate attributeName="opacity" values="1;0.5;1;1" dur="4.5s" repeatCount="indefinite"/>
      </text>
    </svg>

    <div style="font-family:Courier New,monospace;color:#00FF41;opacity:.55;font-size:13px;line-height:1.9;margin:4px auto 0 auto;max-width:560px;text-align:left;">
      ──────────────────────────────────────────────<br/>
      &gt; SYSTEM ONLINE .................... [ OK ]<br/>
    ...
    <img src="https://readme-typing-svg.demolab.com?font=VT323&size=26&duration=2500&pause=700&color=00FF41&center=true&vCenter=true&width=640&lines=%24+python+crawler.py+--category+%E8%93%9D%E7%89%99%E8%80%B3%E6%9C%BA;%24+python+analyzer.py+--report+pain_points.csv;%24+echo+%22MISSION+COMPLETE%22"
         style="margin-top:14px;filter:drop-shadow(0 0 12px #00FF41);"/>
  </div>
</div>
...
<pre style="background:#000;border:1px dashed #00FF41;padding:14px 18px;border-radius:6px;color:#00FF41;line-height:1.75;font-family:Courier New,monospace;">
╔══════════════════════════════════════════════════════════════╗
║  █████╗ ██╗    ███████╗███████╗███╗   ███╗ █████╗ ██████╗   ║
║ ██╔══██╗██║    ██╔════╝██╔════╝████╗ ████║██╔══██╗██╔══██╗  ║
║ ███████║██║    █████╗  █████╗  ██╔████╔██║███████║██████╔╝  ║
...
<details open>
<summary style="color:#00FF41;cursor:pointer;font-size:18px;font-family:Courier New,monospace;">▸ [MODAL_v3.SO] 抗风控 Selenium 采集引擎 &nbsp;&nbsp;<span style="color:#888;">▼ expand</span></summary>
...
<details>
<summary style="color:#00FF41;cursor:pointer;font-size:18px;font-family:Courier New,monospace;">▸ [NLP_KERNEL.SO] TF-IDF + K-Means 聚类核 &nbsp;&nbsp;<span style="color:#888;">▼ expand</span></summary>
...
<details>
<summary style="color:#00FF41;cursor:pointer;font-size:18px;font-family:Courier New,monospace;">▸ [ROOT.YAML] 全局配置注入 &nbsp;&nbsp;<span style="color:#888;">▼ expand</span></summary>
...
<pre style="background:#000;border:1px dashed #00FF41;border-radius:6px;padding:16px 18px;color:#00FF41;font-family:Courier New,monospace;line-height:1.9;">
...
<pre style="background:#1a0000;border:1px solid #ff003c;padding:14px 18px;border-radius:6px;color:#ff003c;font-family:Courier New,monospace;line-height:1.9;">
...
<div align="center" style="color:#00FF41;font-family:Courier New,monospace;">
...
<pre style="text-align:center;color:#00FF41;opacity:.75;font-family:Courier New,monospace;line-height:1.8;">
╔══════════════════════════════════════════════════════════════════╗
