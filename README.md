...
<style>
  ...
  @keyframes soft-breathe{ 0%,100%{transform:scale(1)} 50%{transform:scale(1.01)} }
  .glass{
  ...
  .glass-dark{
    background:linear-gradient(135deg,rgba(255,255,255,.6),rgba(240,249,255,.35));
  ...
  .title-font{font-family:-apple-system,"SF Pro Display","PingFang SC","Segoe UI",sans-serif;}
</style>

<!-- 背景渐变底板（玻璃的灵魂：背后有色彩才有毛玻璃感） -->
<div style="padding:50px 24px 70px 24px;border-radius:32px;position:relative;overflow:hidden;
  ...
  <!-- 漂浮柔光圆 -->
  <div style="position:absolute;top:-60px;left:-60px;width:260px;height:260px;border-radius:50%;background:#a78bfa;filter:blur(90px);opacity:.35;"></div>
  <div style="position:absolute;top:40px;right:-60px;width:260px;height:260px;border-radius:50%;background:#67e8f9;filter:blur(90px);opacity:.45;"></div>
  <div style="position:absolute;bottom:-80px;left:30%;width:320px;height:320px;border-radius:50%;background:#f0abfc;filter:blur(100px);opacity:.4;"></div>

  <!-- 毛玻璃 Hero -->
  <div class="glass title-font" style="position:relative;padding:44px 28px 36px 28px;animation:rise .9s ease both;">
    <span class="soft-pill">✨ v3.0 · Minimal &amp; Elegant</span>
    ...
    <div style="margin-top:22px;display:flex;flex-wrap:wrap;justify-content:center;gap:10px;">
      <span class="soft-pill" style="color:#8b5cf6;background:rgba(237,233,254,.7)">🕷️ Anti-Bot Crawler</span>
      <span class="soft-pill" style="color:#0ea5e9;background:rgba(224,242,254,.7)">🧠 NLP Intelligence</span>
      <span class="soft-pill" style="color:#10b981;background:rgba(220,252,231,.7)">💾 Resume from DB</span>
      <span class="soft-pill" style="color:#f59e0b;background:rgba(254,243,199,.7)">📊 CSV Reports</span>
    </div>
  </div>
</div>
...
<!-- ===== Glass Badge Row ===== -->
<p>
  <img src="https://img.shields.io/badge/Python-3.12%2B-6366F1?style=for-the-badge&logo=python&logoColor=FFE873&labelColor=ffffff&colorA=ffffff"
       style="border-radius:14px;box-shadow:0 6px 18px rgba(99,102,241,.2);" />
  &nbsp;
  <img src="https://img.shields.io/badge/Selenium-UC_Driver-0EA5E9?style=for-the-badge&logo=selenium&logoColor=white&labelColor=ffffff"
       style="border-radius:14px;box-shadow:0 6px 18px rgba(14,165,233,.2);" />
  &nbsp;
  <img src="https://img.shields.io/badge/SQLite3-Database-10B981?style=for-the-badge&logo=sqlite&logoColor=003B57&labelColor=ffffff"
       style="border-radius:14px;box-shadow:0 6px 18px rgba(16,185,129,.2);" />
  &nbsp;
  <img src="https://img.shields.io/badge/TF_IDF+KMeans-NLP-F59E0B?style=for-the-badge&logo=&labelColor=ffffff"
       style="border-radius:14px;box-shadow:0 6px 18px rgba(245,158,11,.2);" />
</p>
<p>
...
<div class="glass-dark title-font" style="padding:20px 26px;">
...
<div class="glass-dark title-font" style="padding:10px 22px 6px 22px;">
...
<div class="glass-dark title-font" style="padding:4px 18px;">
...
<div class="glass-dark title-font" style="padding:10px 18px;">
